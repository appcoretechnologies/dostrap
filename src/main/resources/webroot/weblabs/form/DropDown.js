define([
	...
	var isOpen=false;
	var Button =declare("weblabs.form.DropDown",[_WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin], {
		// summary:
		...
		//		representing a the dropdown default value and a weblabs.form.MenuItem
		...
		// template weblabs/templates/DropDown.html
